// eine Klasse mit Farben ermöglicht den leichten Zugriff auf Farben in meinem Projekt
class Farben {

    // ermöglicht den Zugriff auf die Elemente einer Klasse, ohne dafür eine Instanz zu erstellen
    // für die Farben, ohne jede Logik/Bedingung oder Überprüfung kann man das machen
    companion object {
